  ...
  let SubmissionSample = declare(null, {
    ...
    validate: function () {
      ...
      if (!this.publicationTitle) {
        this.validations.push({
          type: 'error',
          message: 'Publication Title is required. It might be missing from the metadata file. ' +
      ...
      if (!this.collectionDate) {
        ...
        if (this.collectionDate != 'U') {
          ...
          if (!isDateValid) {
            this.validations.push({
              type: 'error',
              message: 'Collection Date is not valid. Valid options: ' +
      ...
      if (this.isolationSourceGender && this.isolationSourceGender !== 'Male' && this.isolationSourceGender !== 'Female') {
        this.validations.push({
          type: 'error',
    ...
    validateStrainName: function (collectionYear) {
      if (this.strainName && this.strainHost) {
        ...
        if (this.strainHost.toUpperCase() === 'HUMAN') {
